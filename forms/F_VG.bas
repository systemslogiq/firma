        ...
        Begin Section
            ...
            Begin
                ...
                Begin ComboBox
                    ...
                    OnNotInList ="[Event Procedure]"
                    ShortcutMenuBar ="cbEmpty"
                    ControlTipText ="Filter nach Firma; (Nachname,Ort, PLZ, Kurzzeichen sind ebenfalls filterbar)\015"
                        "\012Die Liste ist sortiert nach dem Jahr des letzten Vorgangsdatums\015\012Doppe"
                        "lklick zeigt ALLE Firmen"
