...
ErrM:
    ...
    GoTo ErrEnd
End Function
Function OH_GetSMTPAddress(mail As Object) As String
'Funktion zur sicheren SMTP-Ermittlung
    ...
    If mail.SenderEmailType = "EX" Then
        ...
        If Not sender Is Nothing Then
            ...
            If Not exchUser Is Nothing Then
                OH_GetSMTPAddress = exchUser.PrimarySmtpAddress
            End If
        End If
    Else
...
On Error GoTo ErrMsg
    ...
    For Each olItem In olItems
        If TypeName(olItem) = "MailItem" Then
            ' SMTP-Adresse sauber ermitteln (wichtig bei Exchange)
            strSenderAddress = OH_GetSMTPAddress(olItem)
