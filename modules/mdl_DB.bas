...
Option Explicit
    ...
    ' *** NEU: Peppol-Verzeichnisse aus spI_User 260511 EC***
    Global glStrPeppolOutbound As String
    Global glStrPeppolInbound As String
    ' *** NEU: Peppol-Master-Schalter (Lexikon Database) aus spI_User 260511 EC***
    Global glPeppolRechnungsversand As Boolean
...
'   Connection abfragen!!
    ...
    Else
        ...
        ' *** NEU: Peppol-Verzeichnisse aus spI_User 260511 EC***
        glStrPeppolOutbound = Nz(r!glStrPeppolOutbound, "")
        glStrPeppolInbound = Nz(r!glStrPeppolInbound, "")
        ' *** NEU: Peppol-Master-Schalter (Lexikon 'PEPPOL-Rechnungsversand') 260511 EC***
        glPeppolRechnungsversand = (Nz(r!glPeppolRechnungsversand, 0) <> 0)
    End If
...
'<R206>
    ...
    lgAntw = MsgBox(s, vbQuestion + vbYesNoCancel, t)
    If lgAntw = vbCancel Then
        GoTo ErrEnd
    End If
